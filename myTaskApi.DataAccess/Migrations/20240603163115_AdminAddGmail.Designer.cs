...
namespace myTaskApi.DataAccess.Migrations
{
    ...
    [Migration("20240603163115_AdminAddGmail")]
    partial class AdminAddGmail
    {
            ...
            modelBuilder.Entity("myTaskApi.Model.Expense", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Due = new DateTime(2024, 6, 8, 22, 1, 14, 693, DateTimeKind.Local).AddTicks(812),
                            UserId = 100,
                            created = new DateTime(2024, 6, 3, 22, 1, 14, 693, DateTimeKind.Local).AddTicks(440),
                            status = 0,
                        ...
                        new
                        {
                            ...
                            Due = new DateTime(2024, 6, 8, 22, 1, 14, 693, DateTimeKind.Local).AddTicks(2376),
                            UserId = 101,
                            created = new DateTime(2024, 6, 3, 22, 1, 14, 693, DateTimeKind.Local).AddTicks(2370),
                            status = 0,
                        ...
                        new
                        {
                            ...
                            Due = new DateTime(2024, 6, 8, 22, 1, 14, 693, DateTimeKind.Local).AddTicks(2387),
                            UserId = 102,
                            created = new DateTime(2024, 6, 3, 22, 1, 14, 693, DateTimeKind.Local).AddTicks(2385),
                            status = 0,
            ...
            modelBuilder.Entity("myTaskApi.Models.Income", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            start = new DateTime(2024, 6, 3, 22, 1, 14, 691, DateTimeKind.Local).AddTicks(5467)
                        },
                        new
                        {
                            Id = "c002",
                            ...
                            start = new DateTime(2024, 6, 3, 22, 1, 14, 692, DateTimeKind.Local).AddTicks(7255)
                        });
                });
